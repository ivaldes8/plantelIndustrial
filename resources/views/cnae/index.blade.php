                    ...
                    <table class="table table-primary table-bordered table-striped">
                        ...
                        @foreach ($cnae as $item)
                            <tr>
                                ...
                                <td>{{$item->desc}}</td>
                                <td>
                                    <a href="{{url('cnae/'.$item->id.'/edit')}}" class="btn-sm btn-primary"><i class="bi bi-pencil"></i></a>
                                </td>
                                <td>
                                    <button class="btn-sm btn-danger" data-toggle="modal" id="smallButton" data-target="#smallModal" data-attr="{{ url('cnae/delete', $item->id) }}" title="Delete Project">
    ...
    <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">Eliminar CNAE</h5>
